...
import "@/components/effects/MagicRings.css";
...
interface MagicRingsPropsInternal {
  color: string;
  colorTwo: string;
  speed: number;
  ringCount: number;
...
export default function MagicRings({
  ...
  const propsRef = useRef<MagicRingsPropsInternal | null>(null);
  const mouseRef = useRef<number[]>([0, 0]);
  const smoothMouseRef = useRef<number[]>([0, 0]);
