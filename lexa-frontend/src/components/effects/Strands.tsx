...
import "@/components/effects/Strands.css";
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColors: { value: buildPalette(initialProps.colors) },
        uColorCount: { value: Math.min(initialProps.colors.length, MAX_COLORS) },
        uStrandCount: { value: Math.min(initialProps.count, MAX_STRANDS) },
        uSpeed: { value: initialProps.speed },
        uAmplitude: { value: initialProps.amplitude },
        uWaviness: { value: initialProps.waviness },
        uThickness: { value: initialProps.thickness },
        uGlow: { value: initialProps.glow },
        uTaper: { value: initialProps.taper },
        uSpread: { value: initialProps.spread },
        ...
        uSaturation: { value: initialProps.saturation }
      }
    });
    ...
    const renderTarget = new RenderTarget(gl, {
      width: ctn.offsetWidth || 300,
      height: ctn.offsetHeight || 300
    });
    ...
    const glassProgram = new Program(gl, {
      ...
      uniforms: {
        ...
        uResolution: { value: [ctn.offsetWidth || 300, ctn.offsetHeight || 300] },
        uRadius: { value: 0.46 * initialProps.glassSize },
        uRefraction: { value: initialProps.refraction },
        uDispersion: { value: initialProps.dispersion }
      }
    });
