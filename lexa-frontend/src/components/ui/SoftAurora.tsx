...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    if (enableMouseInteraction) {
      gl.canvas.addEventListener('mousemove', handleMouseMove as EventListenerOrEventListenerObject);
    ...
    return () => {
      ...
      if (enableMouseInteraction) {
        gl.canvas.removeEventListener('mousemove', handleMouseMove as EventListenerOrEventListenerObject);
